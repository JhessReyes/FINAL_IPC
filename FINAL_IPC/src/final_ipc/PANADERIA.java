...
public class PANADERIA extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" VENTAS - PANADERIA");

        jLabel2.setText("REG. FACTURA");
        ...
        jLabel6.setText("CONTENIDO DE LA FACTURA");
        ...
        jButton2.setText("REPORTE VENTAS");
        ...
        jButton3.setText("CANT. PROD. VENDIDOS");
        ...
        jButton4.setText("AGREGAR. REG DE FACTURAS");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(scrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(20, 20, 20))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGap(33, 33, 33)))
                .addComponent(scrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18))
        );
    ...
    DefaultListModel<ConFac> Cont = new DefaultListModel<ConFac>();
    JList lista = new JList(Cont);
    ...
    DefaultListModel<FacRe> FacRe = new DefaultListModel<FacRe>();
    JList lista2 = new JList(FacRe);
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        RegVent();
        scrollPane2.add(this.lista2);
...
int y=0;
    public void RegVent(){
        ...
        int z = x + y;
        y=z;
        lista2.setBounds(15, 15, 230, 320);
        FacRe.addElement(new FacRe("Facura No."+jTextField7.getText()+"  ",jTextField1.getText()+" ","NIT: "+jTextField2.getText(),"  Direccion: "+jTextField3.getText(),"  Venta Total: Q. "+ z ));
        setLayout(null);
    }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(null, "GUARDADO CON EXITO!", "REGISTRO", 2);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
    DefaultListModel<ConFac> Cont = new DefaultListModel<ConFac>();
    JList Borrar = new JList(Cont);
    scrollPane1.add(Borrar);
    scrollPane1.removeAll();
    scrollPane1.remove(this.lista);
    Cont.clear();
   ...
   public void AgregarP(){
        String a = (String) jTextField4.getText();
        int a1 = Integer.parseInt(a);
        String b = (String) jTextField6.getText();
        r = jTextField7.getText();
        int b1 = Integer.parseInt(b);
        tot = (a1*b1);
        lista.setBounds(12, 12, 230, 310);
        Cont.addElement(new ConFac("No. "+r+"  ",a1 +" ",jTextField5.getText()+"  ","Q. "+b1+"---->","Q. "+tot));
        setLayout(null);
    }
    /**
